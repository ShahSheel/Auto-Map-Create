 ...
 */
class MapCreateMapsSheet extends BaseSheet
{
 ...
 */
     ...
     */
    protected $_sheetName = 'Panel Router Map';
     ...
     * @var string $_model
     */
    protected $_model = 'Sheel\Map\Models\MapCreateMap';
    ...
    /**
     * This array will define which columns are checked to determine txe pre-existence of a model in the database.
     *
     * @var array $_uniqueColumns
     */
     protected $_uniqueColumns = [ 'name', 'campaign_id', 'screen_id','map_imagery_id' ];
    ...
    protected $_relationships = [
        ...
        'screen' => [
            'Screens' => [ 'media_owner', 'format', 'screen' ]
        ],

        'map_imagery' => [

            'Panel Router Map Imagery' => [ 'map_imagery' ]
